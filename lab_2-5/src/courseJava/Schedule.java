/*
 * Данный класс работает не абсолютно верно, нужно переделать работу с масштабом
 */
...
public class Schedule {
    ...
    public static void create_schedule_addTotal(ArrayList<Point> arrayList_points, ArrayList<Point> linkedList_points) {
        EventQueue.invokeLater(() -> {
            ...
            frame.setTitle("График Add Total Time");                   // устанавливаем заголовок окна
            frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);   // устнавливаем значение по умолчанию при закрытии окна
            ...
            JPanel p = new JPanel() {
                ...
                public void paintComponent(Graphics g) {
                    ...
                    for (int i = 0; i < 39; i++) {
                        ...
                        g2.draw(label);
                        g2.drawString(Integer.toString(385 + (385 * i)), (int)axisY.getX1() - 35, (int)y + 5);
                    }
                    g2.drawString("Y, 10 нс", backgrounds.x + 5, backgrounds.y + 12);
                    g2.setFont(new Font("Calibri", Font.BOLD, 8));
                    g2.drawString("4", backgrounds.x + 27, backgrounds.y + 5);
                    g2.setFont(new Font("Calibri", Font.BOLD, 12));
                    ...
                    for (int i = 0; i < 5; i++) {
                        ...
                        array_y_finish = axisY.getY2() - arrayList_points.get(i).point_y / 10000 / 18.76875;
                        ...
                        link_y_finish = axisY.getY2() - linkedList_points.get(i).point_y / 10000 / 18.76875;
    ...
    public static void create_schedule_removeTotal(ArrayList<Point> arrayList_points, ArrayList<Point> linkedList_points) {
        EventQueue.invokeLater(() -> {
            JFrame frame = new JFrame();                               // создаем новый фрейм
            frame.setExtendedState(JFrame.MAXIMIZED_BOTH);             // устанавливаем окно во весь экран
            frame.setTitle("График Remove Total Time");                // устанавливаем заголовок окна
            frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);   // устнавливаем значение по умолчанию при закрытии окна
            frame.setResizable(false);                                 // запрещаем изменять размер окна
            frame.setVisible(true);                                    // отображаем окно
            ...
            JPanel p = new JPanel() {
                ...
                public void paintComponent(Graphics g) {
                    ...
                    for (int i = 0; i < 5; i++) {
                        ...
                        Line2D label = new Line2D.Double(x, axisX.getY1() - 5, x, axisX.getY1() + 5);
                        g2.draw(label);
                        g2.drawString(Integer.toString((int)Math.pow(10, i)), (int)x - 5 * (i + 1), (int)axisX.getY1() + 20);
                    }
                    g2.drawString("X, шт.", backgrounds.width - 30, backgrounds.height - 10);
    ...
    public static void create_schedule_addMedian(ArrayList<Point> arrayList_points, ArrayList<Point> linkedList_points) {
        EventQueue.invokeLater(() -> {
            JFrame frame = new JFrame();                               // создаем новый фрейм
            frame.setExtendedState(JFrame.MAXIMIZED_BOTH);             // устанавливаем окно во весь экран
            frame.setTitle("График Add Median Time");                  // устанавливаем заголовок окна
            frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);   // устнавливаем значение по умолчанию при закрытии окна
            frame.setResizable(false);                                 // запрещаем изменять размер окна
            frame.setVisible(true);                                    // отображаем окно
            ...
            JPanel p = new JPanel() {
                ...
                public void paintComponent(Graphics g) {
                    ...
                    for (int i = 0; i < 39; i++) {
                        ...
                        Line2D label = new Line2D.Double(axisY.getX1() - 5, y, axisY.getX1() + 5, y);
                        g2.draw(label);
                        g2.drawString(Integer.toString(282 + (282 * i)), (int)axisY.getX1() - 35, (int)y + 5);
                    }
                    g2.drawString("Y, 10 нс", backgrounds.x + 5, backgrounds.y + 12);
                    g2.setFont(new Font("Calibri", Font.BOLD, 8));
                    g2.drawString("2", backgrounds.x + 27, backgrounds.y + 5);
                    g2.setFont(new Font("Calibri", Font.BOLD, 12));
                    ...
                    for (int i = 0; i < 5; i++) {
                        g2.setColor(Color.RED);
                        array_x_finish = axisX.getX1() + arrayList_points.get(i).point_x * 282;
                        array_y_finish = axisY.getY2() - arrayList_points.get(i).point_y / 100 / 13.7475;
                        g2.draw(new Line2D.Double(array_x_start, array_y_start, array_x_finish, array_y_finish));
                        array_x_start = array_x_finish;
                        array_y_start = array_y_finish;
                        ...
                        g2.setColor(Color.BLUE);
                        link_x_finish = axisX.getX1() + linkedList_points.get(i).point_x * 282;
                        link_y_finish = axisY.getY2() - linkedList_points.get(i).point_y / 100 / 13.7475;
                        g2.draw(new Line2D.Double(link_x_start, link_y_start, link_x_finish, link_y_finish));
                        link_x_start = link_x_finish;
                        link_y_start = link_y_finish;
                    }
    ...
    public static void create_schedule_removeMedian(ArrayList<Point> arrayList_points, ArrayList<Point> linkedList_points) {
        EventQueue.invokeLater(() -> {
            JFrame frame = new JFrame();                               // создаем новый фрейм
            frame.setExtendedState(JFrame.MAXIMIZED_BOTH);             // устанавливаем окно во весь экран
            frame.setTitle("График Remove Median Time");               // устанавливаем заголовок окна
            frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);   // устнавливаем значение по умолчанию при закрытии окна
            frame.setResizable(false);                                 // запрещаем изменять размер окна
            frame.setVisible(true);                                    // отображаем окно
            ...
            JPanel p = new JPanel() {
                ...
                public void paintComponent(Graphics g) {
                    ...
                    for (int i = 0; i < 39; i++) {
                        ...
                        Line2D label = new Line2D.Double(axisY.getX1() - 5, y, axisY.getX1() + 5, y);
                        g2.draw(label);
                        g2.drawString(Integer.toString(26 + (26 * i)), (int)axisY.getX1() - 35, (int)y + 5);
                    }
                    g2.drawString("Y, 10 нс", backgrounds.x + 5, backgrounds.y + 12);
                    g2.setFont(new Font("Calibri", Font.BOLD, 8));
                    g2.drawString("3", backgrounds.x + 27, backgrounds.y + 5);
                    g2.setFont(new Font("Calibri", Font.BOLD, 12));
